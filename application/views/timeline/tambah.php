<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Tambah Data Timeline</b>
        </h5>
        <div class="card">
            <div class="card-body">
                <form action="<?= base_url('timeline/create') ?>" method="POST">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="tgl_awal_pendaftaran" class="form-label">Tanggal awal pendaftaran</label>
                                <input type="date" value="<?= set_value('tgl_awal_pendaftaran'); ?>" name="tgl_awal_pendaftaran" class="form-control" id="tgl_awal_pendaftaran">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="<?= set_value('tgl_akhir_pendaftaran'); ?>" name="tgl_akhir_pendaftaran" class="form-control" id="tgl_akhir_pendaftaran">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="<?= set_value('tgl_tes_tertulis'); ?>" name="tgl_tes_tertulis" class="form-control" id="tgl_tes_tertulis">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="date" value="<?= set_value('tgl_pengumuman_tes_tertulis'); ?>" name="tgl_pengumuman_tes_tertulis" class="form-control" id="tgl_pengumuman_tes_tertulis">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="<?= set_value('tgl_tes_wawancara'); ?>" name="tgl_tes_wawancara" class="form-control" id="tgl_tes_wawancara">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="<?= set_value('tgl_pengumuman_tes_wawancara'); ?>" name="tgl_pengumuman_tes_wawancara" class="form-control" id="tgl_pengumuman_tes_wawancara">
