<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Edit User <b class="text-primary"><?= $user->nama ?></b>
        </h5>
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="npm" readonly value="<?= $user->npm ?>" name="npm" class="form-control" id="npm">
                                <?= form_error('npm', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama</label>
                                <input type="nama" value="<?= $user->nama ?>" name="nama" class="form-control" id="nama">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <?php if (!empty(userdata('foto'))) { ?>
                                    <img src="<?= base_url() ?>assets/upload/user-images/<?= $user->foto ?>" class="img-preview img-fluid mb-3 col-lg-5 d-block">
                                <?php } else { ?>
